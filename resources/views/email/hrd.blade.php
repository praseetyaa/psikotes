										...
										<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
											<tr>
												<td>
													...
													<br>
													Sekedar memberitahu bahwa <strong>{{ $pelamar->nama_lengkap }}</strong> telah mendaftar di posisi <strong>{{ $pelamar->posisi->posisi }}</strong> pada tanggal <strong>{{ setFullDate($pelamar->created_at) }}</strong>.
													<br>
